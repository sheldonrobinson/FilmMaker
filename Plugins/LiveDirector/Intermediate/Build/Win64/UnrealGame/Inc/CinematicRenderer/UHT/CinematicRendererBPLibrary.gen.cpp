...
MOVIERENDERPIPELINEMP4ENCODER_API UEnum* Z_Construct_UEnum_MovieRenderPipelineMP4Encoder_EMoviePipelineMP4EncodeProfile();
...
struct Z_Construct_UFunction_UCinematicRendererBPLibrary_RenderCinematicByParameters_Statics
{
	...
	struct CinematicRendererBPLibrary_eventRenderCinematicByParameters_Parms
	{
		...
		FFrameRate FrameRate;
		ECinematicRendererPlaybackQuality PlaybackQuality;
		EMoviePipelineMP4EncodeProfile EncodeProfile;
	};
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "CallInEditor", "true" },
...
DEFINE_FUNCTION(UCinematicRendererBPLibrary::execRenderCinematicByParameters)
{
	...
	P_GET_STRUCT_REF(FFrameRate,Z_Param_Out_FrameRate);
	P_GET_ENUM(ECinematicRendererPlaybackQuality,Z_Param_PlaybackQuality);
	P_GET_ENUM(EMoviePipelineMP4EncodeProfile,Z_Param_EncodeProfile);
	P_FINISH;
	P_NATIVE_BEGIN;
	UCinematicRendererBPLibrary::RenderCinematicByParameters(Z_Param_SequencePath,Z_Param_MapPath,Z_Param_Out_Resolution,Z_Param_Out_FrameRate,ECinematicRendererPlaybackQuality(Z_Param_PlaybackQuality),EMoviePipelineMP4EncodeProfile(Z_Param_EncodeProfile));
	P_NATIVE_END;
}
...
DEFINE_FUNCTION(UCinematicRendererBPLibrary::execRenderCinematicByParametersInternal)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	UCinematicRendererBPLibrary::RenderCinematicByParametersInternal(Z_Param_Out_SequencePath,Z_Param_Out_MapPath,Z_Param_Out_Resolution,Z_Param_Out_FrameRate,ECinematicRendererPlaybackQuality(Z_Param_PlaybackQuality),EMoviePipelineMP4EncodeProfile(Z_Param_EncodeProfile));
	P_NATIVE_END;
}
...
DEFINE_FUNCTION(UCinematicRendererBPLibrary::execRenderCinematicByParametersWithLevelSequenceInternal)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	UCinematicRendererBPLibrary::RenderCinematicByParametersWithLevelSequenceInternal(Z_Param_Sequence,Z_Param_Out_MapPath,Z_Param_Out_Resolution,Z_Param_Out_FrameRate,ECinematicRendererPlaybackQuality(Z_Param_PlaybackQuality),EMoviePipelineMP4EncodeProfile(Z_Param_EncodeProfile));
	P_NATIVE_END;
}
...
// ********** End Class UCinematicRendererBPLibrary constinit property declarations ****************
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UCinematicRendererBPLibrary_RenderCinematicByParameters, "RenderCinematicByParameters" }, // 3171636657
		{ &Z_Construct_UFunction_UCinematicRendererBPLibrary_RenderCinematicByParametersInternal, "RenderCinematicByParametersInternal" }, // 2913214221
		{ &Z_Construct_UFunction_UCinematicRendererBPLibrary_RenderCinematicByParametersWithLevelSequenceInternal, "RenderCinematicByParametersWithLevelSequenceInternal" }, // 3586303297
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_VlogDemo_Plugins_LiveDirector_Source_CinematicRenderer_Public_CinematicRendererBPLibrary_h__Script_CinematicRenderer_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UCinematicRendererBPLibrary, UCinematicRendererBPLibrary::StaticClass, TEXT("UCinematicRendererBPLibrary"), &Z_Registration_Info_UClass_UCinematicRendererBPLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCinematicRendererBPLibrary), 70340237U) },
	};
}; // Z_CompiledInDeferFile_FID_VlogDemo_Plugins_LiveDirector_Source_CinematicRenderer_Public_CinematicRendererBPLibrary_h__Script_CinematicRenderer_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_VlogDemo_Plugins_LiveDirector_Source_CinematicRenderer_Public_CinematicRendererBPLibrary_h__Script_CinematicRenderer_263801813{
	TEXT("/Script/CinematicRenderer"),
	Z_CompiledInDeferFile_FID_VlogDemo_Plugins_LiveDirector_Source_CinematicRenderer_Public_CinematicRendererBPLibrary_h__Script_CinematicRenderer_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_VlogDemo_Plugins_LiveDirector_Source_CinematicRenderer_Public_CinematicRendererBPLibrary_h__Script_CinematicRenderer_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_VlogDemo_Plugins_LiveDirector_Source_CinematicRenderer_Public_CinematicRendererBPLibrary_h__Script_CinematicRenderer_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_VlogDemo_Plugins_LiveDirector_Source_CinematicRenderer_Public_CinematicRendererBPLibrary_h__Script_CinematicRenderer_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_VlogDemo_Plugins_LiveDirector_Source_CinematicRenderer_Public_CinematicRendererBPLibrary_h__Script_CinematicRenderer_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_VlogDemo_Plugins_LiveDirector_Source_CinematicRenderer_Public_CinematicRendererBPLibrary_h__Script_CinematicRenderer_Statics::EnumInfo),
};
// ********** End Registration *********************************************************************
